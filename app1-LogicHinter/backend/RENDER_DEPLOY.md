# Deploy LogicHinter Backend to Render
...
1. Your backend will be available at: `https://logichinter-backend.onrender.com`
2. Test the health endpoint: `https://logichinter-backend.onrender.com/`
