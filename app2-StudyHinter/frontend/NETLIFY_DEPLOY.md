# Deploy StudyHinter Frontend to Netlify
...
- **Base directory**: `app2-StudyHinter/frontend`
- **Build command**: `npm run build`
- **Publish directory**: `app2-StudyHinter/frontend/dist`
...
- **Key**: `VITE_API_URL`
- **Value**: Your Render backend URL (e.g., `https://studyhinter-backend.onrender.com`)
